...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Dex_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f1ef5e10-671a-599f-ac25-3c68827556ba"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Dex", artifacts_toml) for e in artifacts["Dex"]]
...
if best_platform === nothing
    @debug("Unable to load Dex; unsupported platform $(triplet(platform_key_abi()))")
else
